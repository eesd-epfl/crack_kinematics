...
from endpoint_branchpoint import find_end_points
...
def find_crack_kinematics(data_path, mask_name, k_neighboors=30, m=10, l=5, k_n_normal_feature=10, omega = 2, edges=False, normals=False, make_plots_local=False, make_plots_global = False, ignore_global = True, monte_carlo=False, pareto=False, eta = None, cmap_=None, resolution=None, window_overlap=None):
    ...
    contour_dir_nor = find_dir_nor(mask_name,skeleton, dir_save=dir_save, mask=mask, plot=True)
    contour_dir_nor = find_dir_nor(mask_name,skeleton, dir_save=dir_save, mask=None, plot=True)
    ...
    if make_plots_global:
        ...
        #Plot normal and tangential kinematic
        plot_n_t_kinematic(data_path, mask_name, crack_kinematic, dir_save=dir_save, plot_trans_n=True, plot_trans_t=True, plot_trans_t_n=True, local_trans = False, resolution=resolution)
