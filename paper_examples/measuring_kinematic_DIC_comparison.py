...
def get_tn_tt_from_bin(im_name, data_folder, number_measures):
    ...
    for i in range(number_measures):
        ...
        #tt = np.linalg.norm(key_points[4]-key_points[3])# This would work if the points
        #are selected in the proper direction
        kin = np.array([tn,tt])
...
#Comparison against DIC sec 4.5
#dic_patch0_y2062_x1698
data_path = "../data/DIC/Pantoja-Rosero_2021/PR_2021_patches_v2/"        
mask_name = "dic_patch0_y2062_x1698.png" 
im_name = 'dic_patch0_y2062_x1698'
data_folder = 'PR_2021_patches_v2/'
number_measures = 1
...
print("result in mm is ", np.array(tn_tt_read)*.43)


#dic_patch1_y3120_x2432
data_path = "../data/DIC/Pantoja-Rosero_2021/PR_2021_patches_v2/"        
mask_name = "dic_patch1_y3120_x2432.png" 
im_name = 'dic_patch1_y3120_x2432'
data_folder = 'PR_2021_patches_v2/'
number_measures = 1
hyper = [1.0,1.0,4,10,0.0]
approach = "finite_edges"
...
#dic_patch0_y3723_x601
data_path = "../data/DIC/Pantoja-Rosero_2021/PR_2021_patches_v2/"        
mask_name = "dic_patch0_y3723_x601.png" 
im_name = 'dic_patch0_y3723_x601'
data_folder = 'PR_2021_patches_v2/'
number_measures = 1
hyper = [1.0,1.0,4,10,0.0]
approach = "finite_edges"
